// Changed by JinkeGroup: Disable compression
...
// Added by JinkeGroup: Get key (key: "value") this child
...
// Changed by JinkeGroup: Set key to child item
        ...
        public virtual int AsInt
        {
            ...
            {
                int v = 0;
// Changed by JinkeGroup: Consider JSON standard about numbers: http://www.json.org/
        ...
        public virtual bool AsBool
        {
            get
            {
                ...
                if (bool.TryParse(Value,out v))
                    return v;
// Changed by JinkeGroup: Only "true" is a valid JSON bool
//                return !string.IsNullOrEmpty(Value);
        ...
        internal static StringBuilder Escape(string aText, StringBuilder sb) {
            // Added by JinkeGroup: Fixed NRE if value is null
            if (aText == null) {
                return sb;
            }
...
// Removed by JinkeGroup: Complicated and not used
...
//		}
    ...
    public class JSONArray : JSONNode, IEnumerable
    {
        ...
        public override JSONNode this[int aIndex]
        {
            ...
            set
            {
// Added by JinkeGroup: Skip null value (via implicit string operator: only JSONData with null value is null, JSONClass and JSONArray are "")
...
// Added by JinkeGroup: Skip null value (via implicit string operator: only JSONData with null value is null, JSONClass and JSONArray are "")
        ...
        {
// Added by JinkeGroup: Skip null item (via implicit string operator: only JSONData with null value is null, JSONClass and JSONArray are "")
            if ((string) aItem == null)
                return;
// Added by JinkeGroup: Call base.Add
            base.Add(aKey, aItem);
